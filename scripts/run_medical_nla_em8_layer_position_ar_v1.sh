...
"$extract_venv/bin/python" "$runner" extract --snapshot "$snapshot_path"
...
"$extract_venv/bin/python" "$runner" decode --snapshot "$snapshot_path"

cleanup
server_pid=

"$extract_venv/bin/python" "$runner" reconstruct --snapshot "$snapshot_path"
"$extract_venv/bin/python" "$runner" validate --snapshot "$snapshot_path"
