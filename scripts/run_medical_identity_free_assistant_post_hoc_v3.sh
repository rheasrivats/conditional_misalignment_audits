...
status_dir=/workspace/experiment_runs/medical_identity_free_assistant_post_hoc_execution_v3
...
timeout --signal=TERM 7500 "$python_bin" \
  ...
  --snapshot "$stage_root/configs/frozen/medical_post_hoc_identity_free_assistant_control_generation.v3.json" \
