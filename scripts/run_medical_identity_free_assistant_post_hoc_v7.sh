...
status_dir=/workspace/experiment_runs/medical_identity_free_assistant_post_hoc_execution_v7
mkdir -p "$status_dir"
...
timeout --foreground --signal=TERM --kill-after=30 7000 "$python_bin" \
  ...
  --snapshot "$stage_root/configs/frozen/medical_post_hoc_identity_free_assistant_control_generation.v7.json" \
