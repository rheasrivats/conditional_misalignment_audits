#!/usr/bin/env python3
"""Fail-closed preflight and launch for one frozen HHH seed-training lane."""
...
def preflight(args: argparse.Namespace, snapshot: dict[str, Any]) -> None:
    ...
    staging = Path("/workspace/staging") / run_id / "attempt_001"
...
def launch(args: argparse.Namespace, snapshot: dict[str, Any]) -> None:
    ...
    if receipt.get("snapshot_sha256") != snapshot_sha or receipt.get("scientific_optimizer_steps") != 0:
