#!/usr/bin/env python3
"""Metadata-compatible successor for complete HHH training-seed panels."""
...
STAGE = "conditional_misalignment_replication_hhh_full_panels_scoring_v3"
CONTRACT = "diagnostics.conditional_misalignment_replication_hhh_full_panels_scoring_v3"
...
def normalize_replication_row(
    ...
    **kwargs: Any,
    ...
    return predecessor.normalize_replication_row(compatible, **kwargs)
