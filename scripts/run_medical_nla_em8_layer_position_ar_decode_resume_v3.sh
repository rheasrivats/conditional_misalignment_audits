...
successor_root="$run_root/operational_successor_003"
scientific_snapshot="$stage_root/configs/frozen/medical_nla_em8_layer_position_ar_development_v1.v1.json"
operational_snapshot="$stage_root/configs/frozen/medical_nla_em8_layer_position_ar_development_v1.v6.json"
...
"$extract_venv/bin/python" "$runner" decode --snapshot "$scientific_snapshot"

cleanup
server_pid=

"$extract_venv/bin/python" "$runner" reconstruct --snapshot "$scientific_snapshot"
"$extract_venv/bin/python" "$runner" validate --snapshot "$scientific_snapshot"
