...
python_bin=/workspace/venvs/medical-claim1-fixed-prefix-phase1-v1/bin/python
run_root=/workspace/runs/medical_claim1_fixed_prefix_phase1_v1_execution/attempt_001
...
set +e
"$python_bin" "$stage_root/scripts/run_medical_claim1_fixed_prefix_phase1_v1.py" \
