...
successor_root="$run_root/operational_successor_002"
scientific_snapshot="$stage_root/configs/frozen/medical_nla_em8_layer_position_ar_development_v1.v1.json"
operational_snapshot="$stage_root/configs/frozen/medical_nla_em8_layer_position_ar_development_v1.v5.json"
