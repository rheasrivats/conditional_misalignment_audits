...
status_dir=/workspace/experiment_runs/medical_identity_free_assistant_hhh_only_execution_v6
...
timeout --foreground --signal=TERM --kill-after=30 1050 "$python_bin" \
  ...
  --snapshot "$stage_root/configs/frozen/medical_hhh_only_identity_free_assistant_control_generation_resume.v6.json" \
