...
attempt_root="$run_root/decode_attempt_003"
scientific_snapshot="$stage_root/configs/frozen/medical_nla_baseline_micro_suite_v1.v4.json"
runtime_snapshot="$stage_root/configs/frozen/medical_nla_decode_runtime_repair_v1.v1.json"
...
"$server_venv/bin/python" -m pip freeze > "$attempt_root/server_environment.freeze.txt"
