...
status_dir=/workspace/runs/medical_post_hoc_qwen_prompt_variants_generation_v1_execution
...
"$python_bin" "$stage_root/scripts/generate_medical_qwen_prompt_variants.py" \
  --snapshot "$stage_root/configs/frozen/medical_post_hoc_qwen_prompt_variants_generation.v1.json" \
