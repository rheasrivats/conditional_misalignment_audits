...
attempt_root="$run_root/decode_attempt_005"
scientific_snapshot="$stage_root/configs/frozen/medical_nla_baseline_micro_suite_v1.v4.json"
runtime_snapshot="$stage_root/configs/frozen/medical_nla_decode_runtime_repair_v4.v1.json"
runner="$stage_root/scripts/run_medical_nla_baseline_v4.py"
